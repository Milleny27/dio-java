...
public class ExemploOrdenacaoMap {
	public static void main(String[] args) {
		...
		/*
		 * Ordem aleatória - HashMap. Para trabalhar com elementos separadamente -
		 * entrySet. FAzemos um for para imprimir a minha chave e no valor só o nome.
		 */
		...
		/*
		 * Os nomes do livro está no valor, então trabalhamos com o TreeSet, porque eu
